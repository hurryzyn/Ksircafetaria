      ...
      <div class="grid grid-cols-3 gap-4 mb-4">
         <div class="flex items-center justify-center h-28 bg-gray-50 dark:bg-gray-800 rounded">
             <div class="flex flex-col items-center justify-center">
                 ...
                 <h3 class="my-1 font-bold text-lg">100</h3> <!-- Example static value for total users -->
         ...
         <div class="flex items-center justify-center h-28 bg-gray-50 dark:bg-gray-800 rounded">
             <div class="flex flex-col items-center justify-center">
                 ...
                 <h3 class="my-1 font-bold text-lg">50</h3> <!-- Example static value for total transactions -->
                 <div class="bg-light-alt rounded-full p-3">
